...
urlpatterns = [
    ...
    path("accounts/change_password/", auth_views.change_password_page, name="change_password"),
    path("accounts/change_password/submit/", auth_views.PasswordChangeView.as_view(), name="password_change"),
